                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a
                                href="<?php echo Base_URL ?>ListClassController/listClass/<?php echo $class['Object_Id'] ?>/<?php echo $class['Group_Id'] ?>">
                                <?php echo htmlspecialchars($class['Name_class']); ?> - Nhóm
                                <?php echo $class['Group_Id']; ?>
                            </a>
                            <?php endforeach; ?>
                            <?php else: ?>
                    ...
                    <li class="admin-profile">
                        <img src="<?php echo Base_URL ?>public/images/avatars/<?php echo isset($data['admin']->avatar) ? $data['admin']->avatar : 'avatar.jpg'; ?>"
                            alt="Admin Avatar" onclick="toggleDropdown(event)">
                        <div class="profile-dropdown">
                            <a href="<?php echo Base_URL ?>PrivateController"><i class="fa-solid fa-key"></i>Thông tin
                                cá nhân</a>
                            <?php if(isset($data['admin']->Last_login)): ?>

                            <?php endif; ?>
                            <a href="<?php echo Base_URL ?>index/logout"><i class="fa-solid fa-right-from-bracket"></i>
                                đăng xuất</a>
                        </div>
                    </li>
                </ul>
